...
# # 定义变量以便重用
# CONFIG_FILE="codes/configs/celeba_dit_msevae_ditb2_b32_naive_400000.yml"
# GPUS=2
# EXP_DIR="exp/cifar/celeba_dit_msevae_ditb2_b32_naive_400000/"
# LOG_DIR="tumx_log/celebahq"
# MODEL_NAME=$(basename "$CONFIG_FILE" .yml)
# LOG_FILE="${LOG_DIR}/${MODEL_NAME}.log"

# # 使用nohup在后台运行训练脚本
# nohup python codes/train_celebahq_dit.py \
#   --configs ${CONFIG_FILE} \
#   --gpus ${GPUS} \
#   --exp ${EXP_DIR} \
#   > ${LOG_FILE} 2>&1 &
...
# # 用户提示信息，使用变量动态生成
# echo "Training started in the background. Logs are saved to ${LOG_FILE}"
# echo "To monitor logs in real-time: tail -f ${LOG_FILE}"
# echo "To check running processes: ps aux | grep train_celebahq_dit.py"
...
CONFIG_FILE="codes/configs/celeba_dit_msevae_ditb2_b32_naive_400000.yml"
GPUS=2
EXP_DIR="exp/celeba/celeba_dit_msevae_ditb2_b32_naive_400000/"
LOG_DIR="tumx_log/"
MODEL_NAME=$(basename "$CONFIG_FILE" .yml)
